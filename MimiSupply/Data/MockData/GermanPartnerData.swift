...
struct GermanPartnerData {
    ...
    static let restaurantPartners: [Partner] = [
        Partner(
            ...
            heroImageURL: URL(string: "https://cdn.mimisupply.ai/premium/mcdonalds-hero.jpg"),
            logoURL: URL(string: "https://cdn.mimisupply.ai/premium/mcdonalds-logo.png"),
            isVerified: true,
            isActive: true,
            rating: 4.2,
            reviewCount: 1247,
    ...
    static let groceryPartners: [Partner] = [
        Partner(
            ...
            heroImageURL: URL(string: "https://cdn.mimisupply.ai/premium/rewe-hero.jpg"),
            logoURL: URL(string: "https://cdn.mimisupply.ai/premium/rewe-logo.png"),
            isVerified: true,
            isActive: true,
            rating: 4.4,
            reviewCount: 1523,
    ...
    static let pharmacyPartners: [Partner] = [
        Partner(
            ...
            heroImageURL: URL(string: "https://cdn.mimisupply.ai/premium/docmorris-hero.jpg"),
            logoURL: URL(string: "https://cdn.mimisupply.ai/premium/docmorris-logo.png"),
            isVerified: true,
            isActive: true,
            rating: 4.8,
            reviewCount: 2341,
    ...
    static let electronicsPartners: [Partner] = [
        Partner(
            ...
            heroImageURL: URL(string: "https://cdn.mimisupply.ai/premium/mediamarkt-hero.jpg"),
            logoURL: URL(string: "https://cdn.mimisupply.ai/premium/mediamarkt-logo.png"),
            isVerified: true,
            isActive: true,
            rating: 4.1,
            reviewCount: 1876,
